...
## Abbas Telegram Bot is a simple, easy-to-use conversational AI assistant running GPT-3.5 language models.
...
* Install necessary Python packages using the requirementsV1.txt file for the first version or the requirementsV2.txt file for the second.
  ```
...
* `api_key`: Your OpenAI API Key, found on the [OpenAI Dashboard](https://platform.openai.com/account/api-keys).
